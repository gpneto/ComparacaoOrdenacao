...
class GraficoMediaChart extends StatelessWidget {


  GraficoMediaChart({Key key}) : super(key: key);
...
//            new charts.Labe
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData(
    ...
    for (SortParameters item in lista_sort) {
      data.add(OrdinalSales(item.nome, item.media_trocas == null ? 0 : item.media_trocas.toInt()));
    }

    return  [charts.Series<OrdinalSales, String>(
      id: "Grafico Média de Trocas",
...
class LinearVetor {
  ...
  LinearVetor(this.vetor, this.total);
}
